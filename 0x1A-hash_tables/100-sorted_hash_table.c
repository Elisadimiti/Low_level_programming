...
/**
 * make_hash_node - makes a node for the sorted hash table
...
/**
 * hash_table_print - prints a sorted hash table
...
/**
 * hash_table_print_rev - prints a sorted hash table in reverse
 * @ht: hash table to print
 *
 * Return: void
 */
